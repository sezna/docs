...
`),s("span",G,[K,s("span",Y,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),Z,a(`
`),W,a(`
`),L])]),s("pre",H,[s("code",null,[J,a(`
`),s("span",Q,[X,s("span",j,"-"+n(e(l).mochaChainId)+"/keys/keyring-test/",1)]),a(`
`),z,a(`
`),$,a(`
...
`),Ks,a(`
`),Ys,a(`
`),s("span",Zs,[Ws,s("span",Ls,"${PWD}/keys:/root/.celestia-light-"+n(e(l).mochaChainId)+"/keys",1)]),a(`
`),Hs,a(`
`),Js])])]),Qs,s("div",Xs,[js,zs,s("pre",$s,[s("code",null,[sa,a(`
